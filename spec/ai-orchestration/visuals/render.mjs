...
const cases=[
 ['REF-START','start','01-start.png',1440,900],
 ['REF-RUN','working','02-working.png',1440,900],
 ['REF-PLAN','plan','03-plan.png',1440,900],
 ['REF-AGENTS','agents','04-agents.png',1440,900],
 ['REF-DECISION','decision','05-decision.png',1440,900],
 ['REF-RECOVERY','recovery','06-recovery.png',1440,900],
 ['REF-TESTS','tests','07-tests.png',1440,900],
 ['REF-SPEED','performance','08-performance.png',1440,900],
 ['REF-KNOWLEDGE','knowledge','09-knowledge.png',1440,900],
 ['REF-DONE','delivery','10-delivery.png',1440,900],
 ['REF-NARROW','decision','11-narrow.png',960,720],
];
...
try{
 ...
 const url=pathToFileURL(path.join(root,'reference.html')).href;
 ...
 if(manifest){manifest.cleanup={ownedBrowserProcesses:owned.length,remaining:0,temporaryProfileRemoved:true};await fs.writeFile(path.join(root,'manifest.json'),JSON.stringify(manifest,null,2)+'\n');console.log(JSON.stringify({captures:captures.length,prototypeChecks:checks.length,errors,externalRequests:requests.length,cleanup:manifest.cleanup},null,2));}
}
