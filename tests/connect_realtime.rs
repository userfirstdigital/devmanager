...
use devmanager::domain::id::{ClientId, CommandId, OperationId, RequestId, ResourceId, TaskId};
...
fn alternating_concurrent_typing_has_no_controller_lease() {
    ...
    let mut desktop_input = live_input(&session, desktop, command_id(0x34), operation_id(0x44), 10);
