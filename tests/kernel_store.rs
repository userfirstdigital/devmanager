...
fn schema_open_applies_v1_tables_indexes_and_settings() {
    ...
    assert_eq!(rows[6].1, "v7_command_receipt_scope");
    assert_eq!(rows[6].2.len(), 32);
    assert_eq!(rows[7].0, 8);
    assert_eq!(rows[7].1, "v8_provider_input_authority");
    assert_eq!(rows[7].2.len(), 32);
    assert_eq!(rows[8].0, 9);
    assert_eq!(rows[8].1, "v9_semantic_journal");
    assert_eq!(rows[8].2.len(), 32);
    assert_eq!(rows[9].0, 10);
    assert_eq!(rows[9].1, "phase07-prompts-v1");
    assert_eq!(rows[9].2.len(), 32);
    assert_eq!(rows[10].0, 11);
    assert_eq!(rows[10].1, "phase07-prompts-corrections-v2");
    assert_eq!(rows[10].2.len(), 32);
    assert_eq!(rows[11].0, 12);
    assert_eq!(rows[11].1, "phase07-prompts-lineage-authority-v3");
    assert_eq!(rows[11].2.len(), 32);
