...
pub use capabilities::{
    ...
    MAX_PROVIDER_AUTH_PENDING_ENTRIES, MAX_PROVIDER_CAPABILITY_CACHE_ENTRIES,
    MAX_PROVIDER_PATH_BYTES, MAX_PROVIDER_PATH_ENTRIES, MAX_PROVIDER_PATH_VALUE_BYTES,
    MAX_PROVIDER_SHIM_BYTES, MAX_PROVIDER_VERSION_BYTES, PROVIDER_AUTH_NONCE_BYTES,
    PROVIDER_CACHE_KEY_SCHEMA_VERSION, PROVIDER_CAPABILITY_SCHEMA_VERSION,
    PROVIDER_EVIDENCE_SCHEMA_VERSION, PROVIDER_EXECUTABLE_SCHEMA_VERSION,
    PROVIDER_FILE_IDENTITY_SCHEMA_VERSION, PROVIDER_OBSERVATION_SCHEMA_VERSION,
};
pub use registry::{
