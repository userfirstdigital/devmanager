...
pub use portal::{
    ...
    validate_opaque_id, BoardCardProjection, CanonicalEvidenceBundle,
    CanonicalEvidenceImportRequest, ConnectHostDto, CreatePromptVersionRequest,
    EnrollmentPreviewDto, EnrollmentPreviewRequest, EnrollmentViewer, EvidenceContentHash,
    EvidenceMediaRef as PortalEvidenceMediaRef, EvidenceProposedTask, EvidenceRedaction,
    EvidenceReview, EvidenceSignature, EvidenceSourceIdentity, EvidenceTimeRange,
    EvidenceTranscriptSegment, FleetHostDto, FleetLabels, FleetUsageLabels, HostMembershipDto,
    HostReconcileRequest, HostReconcileResponse, LiveViewGrant, LocalActionCatalogDto,
    LocalActionDto, LocalActionReceiptDto, LocalActionReceiptRequest, LocalActionRequestDto,
    LocalPolicyUnits, LocalTaskProjection, ManagedTaskDto as PortalManagedTaskDto,
    ManagedTaskLink as PortalManagedTaskLink, MediaBinding, OrgPromptChainDto,
    OrgPromptChainLinkDto, OrgPromptDiffDto, OrgPromptDto, OrgPromptVersionDto,
    OrganizationGrant as PortalOrganizationGrant, OrganizationPolicyDto, PortalActionKind,
    PortalActionRisk, PortalAdapterError, PortalAdmissionStatus, PortalAuthProvider,
    PortalCredentialHandle, PortalEnrollmentState, PortalGrantAccess, PortalId,
    PortalManagementClient, PortalMembershipStatus, PortalOrgRole, PortalOutcomeStatus, PortalPage,
    PortalPromptStatus, PortalRawSharingCeiling, PortalRequestMetadata, PortalTransport,
    PortalUsageSource, PromptChainRequest, PublishPromptRequest, StaticPortalAuth, TaskLiveViewDto,
    TelemetryUploadAck, TelemetryUploadRequest, TitleConflict as PortalTitleConflict,
    EVIDENCE_BUNDLE_SCHEMA_VERSION, PORTAL_PAGE_MAX_ITEMS,
};
