...
1. In the desktop app, open **Settings → Browser Web UI** and enable it.
2. Open the displayed pairing link once on the phone. Pairing sets a long-lived, host-specific `HttpOnly` browser cookie.
